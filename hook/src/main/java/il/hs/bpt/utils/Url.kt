...
import il.hs.bpt.script.Script
...
fun isBptFrontEnd(url: String?): Boolean {
  if (url == null || !url.endsWith("/Bpt/")) return false
  trustedHosts.forEach { if (url == "https://" + it + "/Bpt/") return true }
  return false
}
