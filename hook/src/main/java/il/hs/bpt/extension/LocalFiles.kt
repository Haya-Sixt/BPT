              ...
              if (!file.exists() && name != "/Bpt.js") {
                ...
                val data =
                    if (name == "/" + background) {
                      ...
                      "<html><head><script>const extension = ${extensions.get(id)!!.put("html", html)}</script><script src='/Bpt.js' type='module'></script></head></html>"
                          .toByteArray()
                    } else if (name == "/Bpt.js") {
                      script.toByteArray()
                    } else {
